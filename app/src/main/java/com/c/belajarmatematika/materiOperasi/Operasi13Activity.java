...
import com.c.belajarmatematika.databinding.ActivityOperasi13Binding;
import com.c.belajarmatematika.matematika.MenuActivity;

public class Operasi13Activity extends AppCompatActivity {

    private ActivityOperasi13Binding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        binding = ActivityOperasi13Binding.inflate(getLayoutInflater());
    ...
    private void setListeners() {
        ...
        binding.lanjut.setOnClickListener(v ->
                startActivity(new Intent(getApplicationContext(), Operasi14Activity.class)));
