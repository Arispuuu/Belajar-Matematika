...
import com.c.belajarmatematika.databinding.ActivityOperasi15Binding;
import com.c.belajarmatematika.matematika.MenuActivity;

public class Operasi15Activity extends AppCompatActivity {

    private ActivityOperasi15Binding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        binding = ActivityOperasi15Binding.inflate(getLayoutInflater());
