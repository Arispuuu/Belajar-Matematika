...
import com.c.belajarmatematika.databinding.ActivityResultOperasi112Binding;
...
public class ResultOperasi112Activity extends AppCompatActivity {
    ...
    private ActivityResultOperasi112Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityResultOperasi112Binding.inflate(getLayoutInflater());
    ...
    public void restartGame112(View view) {
        suarabtn.start();
