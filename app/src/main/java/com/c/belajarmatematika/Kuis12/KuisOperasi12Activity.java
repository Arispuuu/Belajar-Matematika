...
import com.c.belajarmatematika.Kuis11.Kuis11;
import com.c.belajarmatematika.Kuis11.KuisOperasi11Activity;
import com.c.belajarmatematika.Kuis11.ResultOperasi11Activity;
import com.c.belajarmatematika.R;

public class KuisOperasi12Activity extends AppCompatActivity {
    ...
    private Kuis12 mQuestions = new Kuis12();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_operasi12);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (QuestionNum == mQuestions.getLength() -1){
                    ...
                    Intent intent_result = new Intent(KuisOperasi12Activity.this, ResultOperasi112Activity.class);
