...
import com.c.belajarmatematika.Kuis5.Kuis5;
import com.c.belajarmatematika.Kuis5.KuisBangun1Activity;
import com.c.belajarmatematika.R;

public class KuisBangun51Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_bangun51);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (QuestionNum == mQuestions.getLength() -1){
                    ...
                    Intent intent_result = new Intent(KuisBangun51Activity.this, ResultBangun51Activity.class);
