...
import com.c.belajarmatematika.Kuis4.Kuis4;
import com.c.belajarmatematika.Kuis4.KuisSkalaActivity;
import com.c.belajarmatematika.Kuis4.ResultSkalaActivity;
...
public class KuisSkala41Activity extends AppCompatActivity {
    ...
    private Kuis41 mQuestions = new Kuis41();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_skala41);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (QuestionNum == mQuestions.getLength() -1){
                    ...
                    Intent intent_result = new Intent(KuisSkala41Activity.this, ResultSkala41Activity.class);
