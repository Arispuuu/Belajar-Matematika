...
public class ResultSkala41Activity extends AppCompatActivity {
    ...
    private ActivityResultSkala41Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityResultSkala41Binding.inflate(getLayoutInflater());
    ...
    public void restartgame41(View view) {
        suarabtn.start();
