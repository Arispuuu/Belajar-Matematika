...
public class KuisSkala42Activity extends AppCompatActivity {
    ...
    private Kuis42 mQuestions = new Kuis42();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_skala42);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (QuestionNum == mQuestions.getLength() -1){
                    ...
                    Intent intent_result = new Intent(KuisSkala42Activity.this, ResultSkala42Activity.class);
