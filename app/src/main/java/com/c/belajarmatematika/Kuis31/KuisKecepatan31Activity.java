...
import com.c.belajarmatematika.Kuis3.ResultKecepatan1Activity;
import com.c.belajarmatematika.R;

public class KuisKecepatan31Activity extends AppCompatActivity {
    ...
    private Kuis31 mQuestions = new Kuis31();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_kecepatan31);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (QuestionNum == mQuestions.getLength() -1){
                    ...
                    Intent intent_result = new Intent(KuisKecepatan31Activity.this, ResultKecepatan31Activity.class);
