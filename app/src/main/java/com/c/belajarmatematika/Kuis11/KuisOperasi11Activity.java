...
public class KuisOperasi11Activity extends AppCompatActivity {
    ...
    private Kuis11 mQuestions = new Kuis11();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_operasi11);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (QuestionNum == mQuestions.getLength() -1){
                    ...
                    Intent intent_result = new Intent(KuisOperasi11Activity.this, ResultOperasi11Activity.class);
