...
import com.c.belajarmatematika.Kuis31.Kuis31;
import com.c.belajarmatematika.Kuis31.KuisKecepatan31Activity;
import com.c.belajarmatematika.Kuis31.ResultKecepatan31Activity;
import com.c.belajarmatematika.R;

public class KuisKecepatan32Activity extends AppCompatActivity {
    ...
    private Kuis32 mQuestions = new Kuis32();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_kecepatan32);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (QuestionNum == mQuestions.getLength() -1){
                    ...
                    Intent intent_result = new Intent(KuisKecepatan32Activity.this, ResultKecepatan32Activity.class);
