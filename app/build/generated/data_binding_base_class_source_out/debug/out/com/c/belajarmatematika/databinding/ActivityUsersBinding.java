...
public final class ActivityUsersBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView userRescyclerView;
  ...
  private ActivityUsersBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView textErrorMessage, @NonNull RecyclerView userRescyclerView) {
    this.rootView = rootView;
    this.imageBack = imageBack;
    this.progressBar = progressBar;
    this.textErrorMessage = textErrorMessage;
    this.userRescyclerView = userRescyclerView;
  }
  ...
  public static ActivityUsersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.userRescyclerView;
      RecyclerView userRescyclerView = ViewBindings.findChildViewById(rootView, id);
      if (userRescyclerView == null) {
        break missingId;
      }

      return new ActivityUsersBinding((ConstraintLayout) rootView, imageBack, progressBar,
          textErrorMessage, userRescyclerView);
    }
