...
public final class ActivityResultOperasi2Binding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityResultOperasi2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityResultOperasi2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_result_operasi2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityResultOperasi2Binding bind(@NonNull View rootView) {
